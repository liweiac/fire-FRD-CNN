...
export EVAL_DIR="/media/willee/ubuntusoftware/squeezeDetplus9+DATA/logs/train/checkpoint"
...
python ./src/eval.py \
  ...
  --checkpoint_path="/media/willee/ubuntusoftware/squeezeDetplus9+DATA/logs/train/" \
  --net=$NET \
  --gpu=$GPUID
